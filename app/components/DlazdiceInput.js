    ...
    <tr>
      ...
      <td>
        <input
          type="text"
          name="content"
          value={dlazdice.title}
          onChange={e => handleChangeContent(e, dlazdice.id)}
        />
      </td>
      <td>
        <input
          ...
          name="link"
          value={dlazdice.link}
          onChange={e => handleChangeLink(e, dlazdice.id)}
        />
      </td>
      <td>
        <a
          onClick={() => handleRemoveDlazdice(dlazdice.id)}
          type="button"
